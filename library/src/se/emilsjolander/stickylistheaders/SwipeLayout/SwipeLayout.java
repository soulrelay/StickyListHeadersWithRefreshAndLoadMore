...
public class SwipeLayout extends FrameLayout {
    ...
    public SwipeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        int dragEdgeChoices = a.getInt(R.styleable.SwipeLayout_s_drag_edge, DRAG_RIGHT);
        ...
        int ordinal = a.getInt(R.styleable.SwipeLayout_s_show_mode, ShowMode.PullOut.ordinal());
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (changedView == surfaceView) {
                if (mShowMode == ShowMode.PullOut && currentBottomView != null) {
                    ViewCompat.offsetLeftAndRight(currentBottomView, dx);
    ...
    /**
     * the dispatchRevealEvent method may not always get accurate key, it
...
//                mDragHelper.processTouchEvent(event);
    ...
    public void open(boolean smooth, boolean notify) {
        ...
        if (smooth) {
            ...
            mDragHelper.smoothSlideViewTo(bottom, getRight() - mDragDistance, rect.top);
        } else {
